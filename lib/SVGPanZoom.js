...
var SVGPanZoom = function () {
    function SVGPanZoom(svg, options) {
        ...
        var viewBox = (0, _extend2.default)({}, svg.viewBox.baseVal);
                ...
                set initialViewBox(initialViewBox) {
                    ...
                    if (initialViewBox !== null) {
                        if (typeof initialViewBox === "string") {
                            ...
                            viewBox = (0, _extend2.default)({}, defaultViewBox, initialViewBox);
                        } else {
                            throw new Error('initialViewBox is of invalid type');
                        }
                    }

                    _initialViewBox = (0, _extend2.default)({}, viewBox);
                },
                get animationTime() {
        ...
        // Animate method
        var animate = (0, _Animation2.default)(function (state) {
            return setViewBox(svg, state);
        });

        // Getter for ViewBox
        this.getViewBox = function () {
            return (0, _extend2.default)({}, viewBox);
        };
        ...
        (0, _extend2.default)(this.options, (0, _extend2.default)(true, {}, defaultOptions, options));
        ...
        value: function _setupEvents() {
            ...
            touchEvents: {
                ...
                handlers.pinchAndDrag = function (event) {
                    ...
                    var initialViewBox = (0, _extend2.default)({}, this.getViewBox());
